...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #1A7000, #2CC000); background-size: cover;">
      ...
      <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                <i class="fa fa-hospital-o fa-3x" aria-hidden="true" style="color:#1A7000"></i>
                <br>
